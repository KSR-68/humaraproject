      ...
      child: TextFormField(
        ...
        validator: (value) {
          if (value == null || value.isEmpty) {
            ...
            showErrorSnackBar(
                '$label can only contain alphabets and spaces with a maximum length of 64 characters');
            return null;
          } else if (label == 'Email' && !emailRegExp.hasMatch(value)) {
            showErrorSnackBar('Invalid email format');
            return null;
          } else if (label == 'Phone Number' &&
              (!mobileRegExp.hasMatch(value) || value.length != 10)) {
                  ...
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (!nameRegExp.hasMatch(name)) {
                        showErrorSnackBar(
                            'Username can only contain alphabets and spaces with a maximum length of 64 characters');
                        return;
                      }
